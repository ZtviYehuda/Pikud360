# Matzevet UI Foundation — User Feedback Spec

**Domain:** UI Component Specifications  
**Phase:** Sprint 19 — User Feedback  
**Target Path:** [user-feedback.md](file:///C:/Users/nafta/OneDrive/שולחן%2520העבודה/Matzevet/docs/ui/user-feedback.md)

---

## 1. Overview & Redesign Strategy

Matzevet provides instant user feedback for actions. We standardize feedback modules (Toasts, dialogs, undo overlays) to maintain consistent status cues.

---

## 2. Reusable Feedback System

The new [feedback-provider.tsx](file:///C:/Users/nafta/OneDrive/שולחן%2520העבודה/Matzevet/frontend/src/components/ui/feedback-provider.tsx) component implements:
