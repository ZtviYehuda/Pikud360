  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-555 dark:text-slate-400 mt-1">
          {t('dashboard:desc')}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        {/* Metric 1 */}
        <div className="rounded-xl bg-white p-5 shadow-sm border border-slate-200/60 dark:border-slate-800 dark:bg-slate-900 card-hover flex items-center justify-between">
          <div>
            ...
            <span className="text-xs text-green-500 font-semibold mt-2 inline-block">↑ +12% {t('dashboard:month_trend')}</span>
          </div>
        ...
        <div className="rounded-xl bg-white p-5 shadow-sm border border-slate-200/60 dark:border-slate-800 dark:bg-slate-900 card-hover flex items-center justify-between">
          <div>
            ...
            <span className="text-xs text-green-500 font-semibold mt-2 inline-block">✓ {t('dashboard:status_ok')}</span>
          </div>
        ...
        <div className="rounded-xl bg-white p-5 shadow-sm border border-slate-200/60 dark:border-slate-800 dark:bg-slate-900 card-hover flex items-center justify-between">
          <div>
            ...
            <span className="text-xs text-red-500 font-semibold mt-2 inline-block">⚠ {t('dashboard:status_warning')}</span>
          </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 rounded-xl bg-white p-6 border border-slate-200/60 dark:border-slate-800 dark:bg-slate-900 shadow-sm">
        ...
        <div className="rounded-xl bg-white p-6 border border-slate-200/60 dark:border-slate-800 dark:bg-slate-900 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-slate-555 font-medium">{t('dashboard:frontend_client')}</span>
              ...
              {/* Backend API status */}
              <div className="flex items-center justify-between text-sm">
                <span className="text-slate-555 font-medium">{t('dashboard:backend_server')}</span>
                {isHealthLoading ? (
                  <span className="text-xs text-slate-400 animate-pulse">{t('dashboard:checking')}</span>
                ) : healthData?.success ? (
                  <span className="px-2 py-0.5 rounded text-xs font-semibold bg-green-100 text-green-700 dark:bg-green-950/20 dark:text-green-400">
                    {t('dashboard:online')}
                  </span>
