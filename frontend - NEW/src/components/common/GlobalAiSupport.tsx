...
const TOUR_STEPS: TourStep[] = [
  ...
  {
    id: "system_status",
    selector: "#system-status-dot, #mobile-system-status-dot",
    path: "/",
    title: "סטטוס פעילות המערכת",
    content:
      "כאן מופיע חיווי ירוק קבוע המציין שהחיבור לשרת פעיל ומאובטח. לחיצה עליו תציג פרטים על זמן הכניסה האחרון שלך.",
  },
  {
    id: "chat_status_step",
    selector: "#chat-toggle-btn",
    path: "/",
    title: "צ׳אט ישיר בין מפקדים",
    content:
      "בסרגל העליון, ליד הפעמון, ישנו אייקון הודעות (בועת שיחה 💬) — לחיצה עליו פותחת את הצ׳אט הצידי לתקשורת ישירה עם שאר המפקדים ביחידה. שם תוכלו לנהל שיחות פרטיות, לראות מי מחובר כעת (נקודה ירוקה/אדומה), ולעדכן את הסטטוס האישי שלכם (זמין/לא זמין). כפתור זה מופיע רק במחשב.",
  },
  {
    id: "group_message_step",
    selector: "#group-message-btn",
    path: "/",
    title: "שליחת הודעה קבוצתית",
    content:
      "בלחיצה על כפתור הקבוצה (👥), ייפתח חלון לשליחת הודעה מרוכזת. תוכלו לבחור מחלקות, מדורים או חוליות שלמות ולשלוח להם הודעה אחת שתגיע לכל החברים ביחידה שבחרתם ללא צורך לשלוח לכל אחד בנפרד.",
  },
  {
    id: "notifications_bell",
    selector: "#mobile-notifications-btn",
    path: "/",
    title: "פעמון ההתראות",
    content:
      "בסרגל העליון תמצאו את אייקון הפעמון (🔔). לחיצה עליו פותחת חלון עם 3 לשוניות: פעילות — התראות מהמערכת (שוטרים שלא דיווחו, בקשות ממתינות וכו׳), הודעות — מעבר לצ׳אט הפנימי עם המפקדים, והיסטוריה — התראות שכבר קראתם. מספר אדום/כתום על הפעמון מציין כמה התראות ממתינות לטיפולכם.",
  },

  // --- DASHBOARD PAGE ---
  {
    id: "dashboard_filter",
    selector: "#dashboard-filter-btn, #mobile-filter-trigger",
    path: "/",
    title: "סינון",
    content:
      "כפתור הסינון מאפשר לכם לסנן את כל הנתונים בלוח הבקרה לפי יחידה ארגונית (מחלקה/מדור/חוליה), סטטוס, מעמד שירות וטווח גילאים. כך תוכלו לראות נתונים ממוקדים של הצוות שלכם בלבד. ניתן לשלב כמה מסננים יחד, ולנקות הכל בלחיצה אחת.",
  },
  {
    id: "report_hub",
    selector: "#report-hub-card, #report-hub-card-mobile",
    path: "/",
    title: "מרכז הפקת דוחות",
    content:
      "החלק האהוב על המפקדים. מכאן מוציאים את כל דוחות ה-PDF והתמונות לווטסאפ של היחידה בלחיצת כפור.",
  },
  {
    id: "dashboard_event",
    selector: "#event-button, #mobile-event-button",
    path: "/",
    title: "אירוע יחידתי",
    content:
      "יצירת אירועים מיוחדים, תדריכים או פעילויות יחידתיות שיקפצו לכולם בלוח השנה ובהתראות.",
  },
  {
    id: "dashboard_broadcast",
    selector: "#broadcast-button, #mobile-broadcast-button",
    path: "/",
    title: "רשימת תפוצה",
    content:
      "מכאן ניתן לשלוח הודעות מרוכזות לכל היחידה, לצוות מסוים או רק לאלה שלא דיווחו נוכחות.",
  },
  {
    id: "attendance_trend",
    ...
    title: "מגמת זמינות",
    content:
      "גרף המציג את מגמת נוכחות וזמינות השוטרים לאורך זמן (שבועי, חודשי או שנתי). עוזר לזהות מגמות ודפוסי התנהגות ביחידה.",
  },
  {
    id: "status_distribution",
    selector: "#attendance-snapshot-card",
    path: "/",
    title: "חלוקת סטטוסים",
    content:
      "תרשים עוגה/דונאט שמראה את התפלגות השוטרים לפי הסטטוסים השונים (משרד, חופשה, מחלה וכו') עבור היום שנבחר.",
  },
  {
    id: "age_distribution",
    selector: "#age-distribution-card",
    path: "/",
    title: "חתך גילאים",
    content:
      "גרף עמודות המציג את התפלגות הגילאים של שוטרי היחידה, כולל הצגת הגיל הממוצע של כלל המשרתים.",
  },
  {
    id: "birthdays",
    ...
    content:
      "מרכז החגיגות! כאן תוכלו לראות מי חוגג, לשלוח לו ברכה אישית בוואטסאפ או לראות את הפרופיל שלו.",
  },
  {
    id: "stats_comparison",
    selector: "#stats-comparison-card",
    path: "/",
    title: "השוואת כוח אדם",
    content:
      "כלי להשוואת אחוזי נוכחות וזמינות בין המחלקות, המדורים או החוליות השונות. ניתן ללחוץ על יחידה כדי לבצע סינון ולקדוח (Drill-Down) פנימה.",
  },

  // --- ATTENDANCE PAGE ---
  {
    id: "attendance_calendar",
    selector: "#attendance-calendar-btn, #mobile-attendance-calendar-btn",
    path: "/attendance",
    title: "תצוגת לוח שנה",
    content:
      "לחץ כאן כדי לעבור מתצוגת רשימה לתצוגת לוח שנה חודשית, המאפשרת ראייה רחבה של הנוכחות לאורך זמן.",
  },
  {
    id: "attendance_export",
    selector: "#attendance-export-btn, #mobile-attendance-export-btn",
    path: "/attendance",
    title: "ייצוא נתוני נוכחות",
    content:
      "מכאן תוכל לייצא את דוח הנוכחות היומי לקובץ Excel או PDF, וגם לשתף ישירות לוואטסאפ.",
  },
  {
    id: "self_report",
    selector: "#self-report-button, #mobile-self-report-btn",
    path: "/attendance",
    title: "דיווח נוכחות עצמי",
    content:
      "בלחיצה אחת תוכל לעדכן את הנוכחות שלך להיום מבלי לחפש את עצמך ברשימה.",
  },
  {
    id: "bulk_update",
    selector: "#bulk-update-btn, #mobile-bulk-update-btn",
    path: "/attendance",
    title: "עדכון מרוכז",
    content:
      "כלי מהיר לעדכון סטטוס נוכחות למספר שוטרים בבת אחת. סמן את השוטרים הרלוונטיים ולחץ כאן לעדכון גורף.",
  },
  {
    ...
    content:
      "כאן מתבצעת העבודה האמיתית. תוכלו לסנן לפי מדור או צוות ולראות בדיוק מי נמצא איפה.",
  },

  // --- ROSTER / SHIFTS PAGE ---
  {
    id: "roster_grid",
    selector: "#roster-page-container",
    path: "/roster",
    title: "סידור עבודה ומשמרות",
    content:
      "זה הלב של תכנון היחידה. כאן בונים את סידור העבודה לשבוע הקרוב, משבצים משמרות וקובעים תגבורים.",
  },
  {
    id: "roster_status_change",
    selector:
      "#tour-roster-cell, #mobile-tour-roster-cell, #tour-roster-dialog",
    path: "/roster",
    title: "שיבוץ עובד בסידור",
    content:
      "במחשב: העבירו את העכבר מעל התא ולחצו על כפתור הפלוס הכחול (+). בנייד: לחצו ישירות על שורת העובד. ייפתח חלון עם כרטיסי סטטוס לבחירה (משרד, חופשה, מחלה ועוד).",
  },
  {
    id: "roster_weekend_holidays",
    selector:
      "#tour-roster-weekend-cell, #mobile-tour-roster-weekend-cell, #tour-roster-dialog",
    path: "/roster",
    title: "שיבוץ בסופי שבוע וחגים",
    content:
      'בימי שישי, שבת וחגים לא ניתן לבצע שיבוץ עבודה רגיל. המערכת תציג לכם אוטומטית רק אפשרויות לשיבוץ "תגבור" או סטטוס "אחר" עם שדה טקסט חופשי.',
  },
  ...
  {
    id: "add_employee_btn",
    selector: "#add-employee-button, #import-employees-button",
    path: "/employees",
    title: "קליטת עובדים חדשים",
    content:
  ...
  {
    id: "personal_profile",
    selector: "#sidebar-profile-container, #sidebar-profile-link-collapsed",
    path: "/",
    title: "עריכת פרופיל אישי",
    content:
      "בכל שלב במערכת, לחיצה על תמונת הפרופיל או השם שלכם בתחתית סרגל הניווט תוביל אתכם ישירות לעדכון הפרטים האישיים, הגדרת PIN, ורישום זיהוי ביומטרי.",
  },
  {
    id: "appearance_palette",
    selector: "#appearance-settings-page",
    path: "/settings?tab=appearance",
    title: "נראות ועיצוב המערכת",
    content:
      "מכאן תוכלו להתאים את המערכת בדיוק להעדפות שלכם: לבחור מראה יום/לילה, לשנות את גודל הגופן לתצוגה נוחה, ולבחור את צבע התצוגה המרכזי של המערכת.",
  },
  {
    id: "settings_security",
    selector: "#security-tab, #mobile-security-tab",
    path: "/settings?tab=security",
    title: "אבטחה וסיסמה",
    content:
      "צריכים להחליף סיסמה? זה המקום. מומלץ להחליף סיסמה פעם בכמה חודשים לשמירה על אבטחת החשבון.",
  },
];
...
const KNOWLEDGE_BASE = [
  {
    ...
    description:
      'את סידור העבודה והמשמרות לשבוע הקרוב מנהלים בדף ה"רוסטר". שם תוכל לשבץ עובדים לכל יום בשבוע.',
    stepId: "roster_grid",
  },
  {
    id: "add_employee",
    ...
    description:
      "כדי להוסיף עובד חדש ליחידה, עליך לעבור לדף ניהול עובדים וללחוץ על כפתור הוספה (סימן הפלוס).",
  ...
  },
  {
    ...
    description:
      "כדי לעדכן את הפרטים האישיים שלך, להגדיר קוד PIN או לשנות סיסמה, לחץ על שמך או תמונת הפרופיל שלך בתחתית תפריט הצד.",
  ...
  },
  {
    ...
    description:
      "ניהול הנוכחות היומי מתבצע בדף היומן. שם מעדכנים מי נמצא ביחידה ברגע זה.",
  ...
  },
  {
    ...
    description:
      'את כל הדוחות היחידתיים ניתן להפיק מתוך "מרכז הדוחות" בלוח הבקרה הראשי. במסך הנוכחות ניתן גם לייצא נתונים בעזרת כפתור הייצוא.',
    stepId: "report_hub",
  },
  {
    id: "excel_export",
    ...
    description:
      'כדי לייצא דוח נוכחות מפורט בפורמט Excel או PDF לפי טווח תאריכים מוגדר, לחץ על "ייצוא" הממוקם בסרגל הכלים העליון במסך הנוכחות.',
  ...
  },
  {
    ...
    keywords: [
      ...
      "מגמת זמינות",
      "גרף מגמה",
      "גרף נוכחות לאורך זמן",
      "מגמות",
      "שינוי זמינות",
    ],
    context: ["גרפים", "נתונים", "סטטיסטיקה"],
    description:
      "גרף מגמת זמינות מראה את אחוז הנוכחות והזמינות של היחידה לאורך זמן לפי טווח הימים שבחרת.",
  ...
  },
  {
    ...
    context: ["גרפים", "נתונים", "סטטיסטיקה"],
    description:
      "גרף חלוקת סטטוסים מציג את התפלגות השוטרים ביחידה לפי הסטטוסים השונים (משרד, חופשה, מחלה וכו') להיום.",
  ...
  },
  {
    ...
    context: ["גרפים", "נתונים", "סטטיסטיקה"],
    description:
      "גרף חתך גילאים מציג את התפלגות המשרתים ביחידה לפי קבוצות גיל שונות, ומציג את הגיל הממוצע.",
  ...
  },
  {
    ...
    context: ["גרפים", "נתונים", "סטטיסטיקה"],
    description:
      "גרף השוואת כוח אדם מאפשר להשוות את אחוזי הנוכחות והזמינות של יחידות משנה. לחיצה על יחידה תרד רמה (מחלקה -> מדור -> חוליה -> שוטר).",
  ...
  },
  {
    ...
    description:
      'לעדכון מרוכז, עבור למסך הנוכחות ולחץ על כפתור "עדכון מרוכז" בסרגל העליון (או בחר מספר שוטרים מהרשימה).',
    stepId: "bulk_update",
  },
  {
    id: "self_report_kb",
    ...
    context: ["דיווח", "יומן"],
    description:
      'כדי לדווח נוכחות על עצמך במהירות, לחץ על "דיווח עצמי" בסרגל העליון של דף הנוכחות.',
    stepId: "self_report",
  },
  {
    ...
    description:
      'באפשרותך לראות את נתוני הנוכחות בפריסה חודשית מלאה על ידי מעבר ל"לוח שנה" במסך הנוכחות.',
  ...
  },
  {
    ...
    description:
      'ניתן לשלוח הודעות מרוכזות לקבוצות או לכל היחידה בעזרת כפתור "רשימת תפוצה" בלוח הבקרה.',
  ...
  },
  {
    ...
    description:
      'ניתן ליצור אירועים יחידתיים ותדריכים בעזרת כפתור "אירוע" הממוקם בלוח הבקרה תחת מרכז הדוחות.',
  ...
  },
  {
    ...
    description:
      'ניתן לשנות את צבעי המערכת ואת ערכת הנושא דרך דף ההגדרות בלשונית "מראה ותצוגה".',
  ...
  },
  {
    ...
    description:
      'מערכת הסינון החדשה מאפשרת לך לדייק את הנתונים המוצגים לפי מגוון קטגוריות. ניתן לסנן לפי יחידה ארגונית, סטטוס דיווח, מעמד השירות וטווח גילאים. חשוב לזכור ללחוץ על כפתור "החל סינון" בסיום הבחירה.',
  ...
  },
  {
    ...
    description:
      'הוספנו סליידר גילאים חדש בלשונית "גילאים" שבתוך מסך הסינון. ניתן לגרור את שני הקצוות כדי לקבוע טווח גילאים מדויק (למשל: 18 עד 25) ולראות רק את השוטרים המתאימים.',
    stepId: "dashboard_filters",
  },
  {
    id: "apply_logic",
    ...
    description:
      'במערכת החדשה, הנתונים מתעדכנים רק לאחר לחיצה על כפתור "החל סינון" בתחתית מסך הסינון. זה מאפשר לך לבחור כמה קטגוריות יחד בצורה מרוכזת ומהירה.',
    stepId: "dashboard_filters",
  },
  {
    id: "full_tour",
    ...
    description:
      "אשמח לעשות לך סיור מודרך! נראה את לוח הבקרה, ניהול הנוכחות, סידור העבודה וניהול העובדים.",
...
*כל המידע מוגן ומסונן אוטומטית בהתאם לרמת הפיקוד וההרשאות שלך בלבד (כולל הרשאת מפקד מחליף).*`,
  ...
  const getStorageKey = () =>
    user?.id ? `ai_support_messages_${user.id}` : "ai_support_messages";
    ...
    if (currentTourIndex >= 0) {
      ...
      if (step) {
        ...
        window.dispatchEvent(
          new CustomEvent("tour-step-changed", {
  ...
  useEffect(() => {
    if (currentTourIndex >= 0 && !isSingleStep) {
      const step = TOUR_STEPS[currentTourIndex];
      if (
        step?.id === "chat_status_step" ||
        step?.id === "group_message_step"
      ) {
        if (!isChatOpen) {
  ...
  const findMatches = (input: string) => {
    ...
    const cleanTokens = text
      .split(/\s+/)
      .filter((t) => !noiseWords.includes(t) && t.length > 1);
    ...
    const scoredMatches = KNOWLEDGE_BASE.map((item) => {
      ...
      // 4. Token overlap
      const matchingTokens = cleanTokens.filter(
        (t) =>
  ...
  const handleSend = async (e?: React.FormEvent) => {
    ...
    if (isWorkforceQuery) {
      ...
      const fallbackText = `${header}\nℹ️ **לא נמצאו עובדים במערכת המתאימים לחיפוש זה.**\n\n*נכון לעכשיו לא קיימים במערכת עובדים המשובצים בנתוני הפיקוד והתאריך המבוקשים.*`;
    ...
    setTimeout(() => {
      ...
      const isDominant =
        topMatch && (!matches[1] || topMatch.score > matches[1].score + 35);
      ...
      if (isDominant) {
        ...
        setMessages((prev) => [
          ...
          {
            id: Date.now().toString(),
            text: "מצאתי כמה דברים שקשורים לבקשה שלך. למה התכוונת?",
            isBot: true,
            suggestions: matches
              .slice(0, 4)
              .map((m) => ({ label: m.title, stepId: m.stepId })),
          },
        ]);
      } else {
        setMessages((prev) => [
          ...
          <motion.div
            ...
            onDragEnd={(_, info) => {
              ...
              if (isOffScreen || isNearEdge) {
                ...
                toast.info("כפתור הסיוע הוסתר", {
                  description:
                    "כדי להחזיר אותו, עבור להגדרות → נראות → כפתור סיוע AI",
                  position: "top-center",
                  duration: 8000,
                  action: {
                    label: "פתח הגדרות",
            ...
            className={cn(
              ...
              (isMessagesTab ||
                (isOpen && !isMinimized) ||
                (currentTourIndex >= 0 &&
                  TOUR_STEPS[currentTourIndex]?.path === location.pathname)) &&
                "hidden",
            )}
          >
            <AnimatePresence>
            ...
            >
              <motion.div
                animate={{ rotate: showQuickMenu ? 45 : 0 }}
                transition={{ type: "spring", stiffness: 400, damping: 25 }}
              >
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-black text-xs uppercase text-slate-800 dark:text-slate-100">
                    צ'אט תמיכה
                  </h3>
                </div>
                      ...
                      <>
                        ...
                        <div className="absolute left-0 mt-2 w-48 bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-border p-1.5 z-50 flex flex-col gap-1">
                          ...
                          >
                            ...
                            <span>
                              {showHistory ? "חזור לצ'אט" : "היסטוריית חיפושים"}
                            </span>
                          </button>
                          <button
                  ...
                  <div className="h-full overflow-y-auto p-5 space-y-2 no-scrollbar">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button
                        ...
                        className="text-[10px] font-bold text-primary bg-primary/10 px-2 py-1 rounded-lg"
                      >
                        חזור לצ'אט
                      </button>
                    </div>
                      ...
                      <div key={msg.id} className="flex flex-col gap-2">
                        ...
                        {msg.isBot && msg.action && (
                          <Button
                            variant="outline"
                            size="sm"
                            className="mr-8 ml-0 self-start rounded-xl border-emerald-200 text-emerald-600 font-black text-[11px] h-9 gap-2 hover:bg-emerald-50 dark:hover:bg-emerald-950"
                            onClick={() => handleAction(msg.action!.stepId)}
                          >
                          ...
                          <div className="mr-8 ml-0 flex flex-col gap-2">
                            {msg.suggestions.map((s, idx) => (
                              <Button
                                ...
                                variant="outline"
                                size="sm"
                                className="rounded-xl border-primary/20 text-primary font-black text-[11px] h-9 justify-start gap-2 hover:bg-primary/10 dark:hover:bg-primary/20"
                                onClick={() => handleAction(s.stepId)}
                              >
              ...
              <div className="p-5 border-t border-border bg-white dark:bg-slate-900">
                <form
                  onSubmit={handleSend}
                  className="flex gap-2 bg-slate-100 dark:bg-slate-800 p-2 rounded-2xl"
                >
                  <input
                    value={chatInput}
                    onChange={(e) => setChatInput(e.target.value)}
                    placeholder="שאל אותי משהו..."
                    className="flex-grow bg-transparent border-none text-slate-800 dark:text-slate-100 text-xs font-bold px-3 focus:ring-0 text-right"
                    style={{ direction: "rtl" }}
                  />
                  <button
                    type="submit"
                    className="w-10 h-10 bg-primary/20 hover:bg-primary/30 text-primary border border-primary/30 rounded-xl flex items-center justify-center shadow-sm transition-all"
                  >
          ...
          >
            <Trash2
              className={cn(
                ...
                isNearDrop
                  ? "text-red-500 scale-120 rotate-12"
                  : "text-muted-foreground",
              )}
            />
            <span
              className={cn(
                "text-[10px] font-black tracking-wider transition-colors duration-200",
                isNearDrop ? "text-red-500" : "text-muted-foreground",
              )}
            >
              גרור לכאן להסתרה
            </span>
