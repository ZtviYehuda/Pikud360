...
const ACTION_CONFIG: Record<string, { label: string; icon: any; color: string; bg: string }> = {
  ...
  IMPERSONATION_START: { label: "התחזות מנהל", icon: Activity, color: "text-amber-600", bg: "bg-amber-500/10" },
  USER_IMPERSONATION: { label: "התחברות אדמין (התחזות)", icon: Shield, color: "text-amber-600", bg: "bg-amber-500/10" },
  USER_IMPERSONATION_EXIT: { label: "יציאה מהתחזות (חזרה לאדמין)", icon: UserCheck, color: "text-emerald-600", bg: "bg-emerald-500/10" },
  IMPERSONATION_EXIT: { label: "יציאה מהתחזות", icon: UserCheck, color: "text-emerald-600", bg: "bg-emerald-500/10" },
  EMPLOYEE_VIEWED: { label: "צפייה בשוטר", icon: User, color: "text-blue-600", bg: "bg-blue-500/10" },
  READ: { label: "צפייה בנתונים", icon: User, color: "text-slate-600", bg: "bg-slate-500/10" },
