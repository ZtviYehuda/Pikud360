...
export default function TermsPage() {
  ...
  const sections = [
    {
      title: "אודות המערכת והשימוש המורשה",
      content:
        "מערכת THE OFFICE משמשת כמרכז שליטה, דיווח וניהול כוח אדם יחידתי. המערכת מיועדת אך ורק לבעלי תפקידים מורשים לצורך ביצוע משימותיהם המבצעיות והפיקודיות.",
    },
    {
      title: "סיווג המידע ואחריות המשתמש",
      content:
        "המידע במערכת הינו בסיווג 'שמור'. כל משתמש אחראי באופן אישי לשמירה על סודיות פרטי הגישה שלו, הסיסמה והאימות האישי. חל איסור מוחלט על מסירת פרטי גישה לגורם אחר.",
    },
    {
      title: "הנחיות מיוחדות להעברת מידע ל-WhatsApp",
      content:
        "המערכת כוללת אפשרות לשיתוף והפצת דיווחים והודעות ל-WhatsApp. חלה חובה מוחלטת וקריטית על המשתמש לשים לב מלאה לאן ולמי מועבר המידע! יש לוודא לפני כל שליחה שהנמענים או קבוצת הוואטסאפ הינם גורמים מורשים בלבד לקבלת המידע המבצעי בסיווג 'שמור'.",
    },
    {
      title: "ניטור ובקרה",
      content:
        "כל הפעולות במערכת - לרבות כניסות, עריכות, הפצת הודעות וייצוא נתונים - מתועדות ונרשמות באופן מלא ביומן הביקורת (Audit Log) של המערכת.",
    },
  ];
